...
#define STRING_CONFIG_H_AUTHOR "(CheapSkate Eng, Doug, 306)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "306 " SHORT_BUILD_VERSION // will be shown during bootup in line 1
...
#define CUSTOM_MACHINE_NAME "MPCNC 306"  //V1 E CNC
