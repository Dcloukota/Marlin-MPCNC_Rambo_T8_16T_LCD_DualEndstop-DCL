...
//#define Z_DUAL_STEPPER_DRIVERS   NOT USED IN MPCNC
...
#define QUICK_HOME                     // If homing includes X and Y, do a diagonal move initially 311
...
#define MICROSTEP_MODES { 16, 16, 16, 16, 16, 16 } // [1,2,4,8,16] { 16, 16, 16, 16, 16, 16 }
 ...
 */
//#define PWM_MOTOR_CURRENT { 1300, 1300, 1250 }          // Values in milliamps   311
...
//#define BABYSTEPPING
  ...
  #define MOVE_Z_WHEN_IDLE                // Jump to the move Z menu on doubleclick when printer is idle.  //309
  #if ENABLED(MOVE_Z_WHEN_IDLE)
    #define MOVE_Z_IDLE_MULTIPLICATOR 1     // Multiply 1mm by this factor for the move step size.
  #endif

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //309
